...
+ (Done) A rpi webcam livestream server (Which I might implement later on the rpi tank project).
+ (Done) An altoids/mint box arcade game handheld made with upcycled vape batteries.
